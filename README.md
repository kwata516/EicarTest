# EicarTest
.bat script  of  eicar.txt file. Please use this for detection function monitoring with antivirus software or EDR solutions. It works in both Japanese and English environments.
